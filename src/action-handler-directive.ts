...
// TODO You need to replace all instances of "action-handler-person" with "action-handler-<your card name>"
customElements.define('action-handler-person', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-person')) {
    return body.querySelector('action-handler-person') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-person');
